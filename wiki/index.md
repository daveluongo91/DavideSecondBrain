...
- [Adesso](dashboards/now.md) — Le priorità correnti e le prossime azioni del sistema. _(active)_
- [Progetti](dashboards/projects.md) — Vista sintetica dei progetti attivi e pianificati. _(active)_
...
- [Accessori fotografici](gear/accessories.md) — Accessori utili per inseguimento, supporto, audio, monitoraggio e movimento. _(active)_
- [Corpi macchina](gear/cameras.md) — Mappa dei corpi macchina e del ruolo di ciascuno nel sistema fotografico. _(active)_
- [Filtri](gear/filters.md) — Filtri fotografici e ruolo nei progetti di paesaggio e astrofotografia. _(active)_
- [Obiettivi](gear/lenses.md) — Obiettivi principali e loro ruolo creativo o tecnico. _(active)_
- [Software fotografico](gear/software.md) — Software principali per post-produzione, stitching, astro e montaggio. _(active)_
...
- [Workflow di post-produzione](workflows/photo-processing.md) — Struttura per documentare elaborazioni fotografiche complesse e renderle ripetibili. _(active)_

## Persone

- [Loris Ferrini](people/loris-ferrini.md) — Collaboratore e co-host in workshop e photo tour. _(active)_

## Organizzazioni

- [Maven Filters](organizations/maven-filters.md) — Collaborazione relativa a filtri e fotografia di paesaggio. _(active)_
- [RCE Foto](organizations/rce-foto.md) — Collaborazione per test di fotocamere, contenuti e accesso a corpi diversi. _(active)_
- [Sigma Italia](organizations/sigma-italia.md) — Partner tecnico e relazione ambassador legata a fotografia e obiettivi. _(active)_
- [Vanguard](organizations/vanguard.md) — Partner ambassador per zaini, treppiedi e supporto alle attività fotografiche. _(active)_

## Decisioni

- [Principi del sistema attrezzatura](decisions/gear-system-principles.md) — Criteri per tenere, vendere o acquistare corpi, obiettivi e accessori. _(active)_

## Domande

- [Domande aperte](questions/open-questions.md) — Questioni non ancora risolte che possono guidare ricerca e decisioni. _(active)_

## Template

- [Idea contenuto](templates/content-idea.md) — Modello per sviluppare e misurare un contenuto. _(reference)_
- [Nome entità](templates/entity.md) — Modello per persone, organizzazioni, prodotti o luoghi. _(reference)_
- [Riunione YYYY-MM-DD](templates/meeting-note.md) — Modello per una riunione o un allineamento. _(reference)_
- [Titolo decisione](templates/decision.md) — Modello per registrare una decisione e le sue conseguenze. _(reference)_
- [Titolo fonte](templates/source-note.md) — Modello per una nota di sintesi di una fonte. _(reference)_
- [Titolo progetto](templates/project.md) — Modello per una pagina progetto. _(reference)_

## Altro

- [Home](home.md) — Punto di ingresso del second brain di Davide. _(active)_
